            ...
            <div class=" span10 bottom_shadow img_bk">
                ...
                <form id="session" method="post">
                    <div class="btn-group middle_con">
                        ...
                        <button class="btn btn-inverse btn-large" onclick="user_choice(2)">Itinerary</button>
                        <button class="btn btn-inverse btn-large" onclick="user_choice(3)">Pay Online</button>
                    </div>
                                ...
                                try {
                                    ...
                                    if (action.compareTo("pick") == 0) {
                                        if (chosen == 1) {
                                            ...
                                            response.sendRedirect("Itinerary.jsp");
                                        } 
                                    }
                                } catch (Exception e) {
